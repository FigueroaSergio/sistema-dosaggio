...
<template>
  <div class="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl">
      ...
      >
        <span class="text-2xl md:text-3xl font-bold text-white">Inizia ricetta</span>
      </button>
      ...
      >
        <span class="text-2xl md:text-3xl font-bold text-white">Gestione ricette</span>
      </button>
      ...
      >
        <span class="text-2xl md:text-3xl font-bold text-white">Historico ricette</span>
      </button>
    </div>
  </div>
</template>
